          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: "rgba(167, 205, 201, 0.7)" }}>
            ...
            {reportSuccess && (
              ...
              >
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-5 h-5 mt-0.5 flex-shrink-0" style={{ color: "#86BBB5" }} />
                  <div className="flex-1">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <span style={{ color: "rgba(167, 205, 201, 0.7)" }}>City:</span>
                          <span className="ml-2 font-medium" style={{ color: "#F9FAFB" }}>
                            {reportSuccess.city}
                          </span>
                        </div>
                        <div>
                          <span style={{ color: "rgba(167, 205, 201, 0.7)" }}>Date:</span>
                          <span className="ml-2 font-medium" style={{ color: "#F9FAFB" }}>
                            {reportSuccess.date}
                          </span>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <span style={{ color: "rgba(167, 205, 201, 0.7)" }}>Size:</span>
                          <span className="ml-2 font-medium" style={{ color: "#F9FAFB" }}>
                            {reportSuccess.size} KB
                          </span>
                        </div>
                        <div>
                          <span style={{ color: "rgba(167, 205, 201, 0.7)" }}>Storage:</span>
                          <span className="ml-2 font-medium" style={{ color: "#86BBB5" }}>
                      ...
                      >
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <span className="text-xs font-medium" style={{ color: "#A7CDC9" }}>
                            Report Preview
                          </span>
                        </div>
                        <div className="text-xs space-y-1">
                          <div style={{ color: "#F9FAFB" }}>
                            🌡️ {reportSuccess.preview.current_temp} - {reportSuccess.preview.weather_desc}
                          </div>
                          <div style={{ color: "rgba(167, 205, 201, 0.8)" }}>
                            📰 {reportSuccess.preview.top_headline || 'Latest news included'}
                          </div>
                          <div style={{ color: "rgba(167, 205, 201, 0.6)" }}>
                            📊 {reportSuccess.preview.forecast_items} forecasts, {reportSuccess.preview.news_items} news items
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            {!reportSuccess && !reportError && (
              <div className="text-center">
                <p className="text-sm" style={{ color: "rgba(167, 205, 201, 0.6)" }}>
                  Creates a comprehensive JSON report with current weather, 5-day forecast, and latest news for <strong>{currentCity}</strong>
                </p>
              </div>
            )}
          </div>
